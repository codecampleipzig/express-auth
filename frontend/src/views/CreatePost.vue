  ...
  <div class="container max-w-screen-md mx-auto py-8 px-2">
    ...
    <main>
      <form
        ...
        class="grid gap-4 bg-gray-100 shadow-sm rounded p-6"
      >
        <input
          class="bg-transparent focus:outline-none font-bold text-xl mb-2 text-gray-800"
          type="text"
          v-model="form.title"
          placeholder="Title"
        />
        <textarea
          class="bg-transparent resize-none h-64 text-gray-600 focus:outline-none"
          @input="form.content = $event.target.value"
          placeholder="Write something..."
        ></textarea>
        <div class="flex justify-end">
          <input
            class="block p-2 px-12  bg-blue-100 rounded
