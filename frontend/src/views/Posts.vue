<template>
  <div class="container max-w-screen-md mx-auto py-8 px-2">
    ...
    <main class="card-grid">
      <div class="bg-gray-100 shadow-sm rounded p-6" v-for="post in posts" :key="post.id">
...
export default {
  computed: {
    posts() {
      return this.$store.state.posts.slice().sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
    }
  },
  mounted() {
